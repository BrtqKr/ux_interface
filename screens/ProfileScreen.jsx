    ...
    return (
      <ScrollView style={styles.mainContainer}>
        <Container visible={this.state.settings}>
          <Text
            style={[styles.normalText, { marginHorizontal: 20, fontSize: 10 }]}
          >
            New Password
          </Text>
          <Input
            ...
            style={styles.input}
            onChange={evt => {
              this.setState({ password: evt.nativeEvent.text });
            }}
          />
          <Text
            style={[styles.normalText, { marginHorizontal: 20, fontSize: 10 }]}
          ...
          <Input
            ...
            style={styles.input}
            onChange={evt => {
              this.setState({ confirmedPassword: evt.nativeEvent.text });
            }}
          />
          <View
            style={{
          ...
          >
            ...
            <TouchableOpacity
              onPress={event => {
                if (this.state.password !== this.state.confirmedPassword)
                  ...
                  console.warn("password could not be empty!");
            ...
            >
              <AntDesign
                ...
                size={40}
                color={"#F7F7F7"}
                style={{ backgroundColor: "#F5A315", height: 40, width: 40 }}
              />
            </TouchableOpacity>
          </View>
        </Container>
        ...
        <View style={styles.viewContainer}>
          ...
          <View style={styles.informationContainer}>
            ...
            <View
              style={{ borderBottomColor: "30323b", borderBottomWidth: 4 }}
            />
          ...
          >
            <Image
              ...
              style={
                this.state.settings
                  ? styles.settingsPhotoRotated
                  : styles.settingsPhoto
              }
            />
          </TouchableOpacity>
        </View>
        <View style={styles.buttonBar}>
          <View style={styles.buttonStyle}>
            <TouchableOpacity
              onPress={event => {
                Alert.alert("Your friends subscreen");
              }}
            >
          ...
          <View style={styles.buttonStyle}>
            <TouchableOpacity
              onPress={event => {
                Alert.alert("Your sessions subscreen");
              }}
            >
          ...
          <View style={styles.buttonStyle}>
            <TouchableOpacity
              onPress={event => {
                Alert.alert("Your games subscreen");
              }}
            >
        ...
        <View style={styles.recentSessions}>
          <Text style={[styles.normalText, { fontSize: 18, margin: 20 }]}>
            Recent Sessions
          </Text>
          <View style={styles.session}>
            ...
            <View style={styles.sessionInfo}>
              <View style={{ flex: 1, flexDirection: "row" }}>
                ...
                >
                  <Image
                    source={{ uri: sessions[0][0] }}
                    style={styles.smallPhoto}
                  />
                  <Image
                    source={{ uri: sessions[0][1] }}
                    style={styles.smallPhoto}
                  />
                  <Image
                    source={{ uri: sessions[0][2] }}
                    style={styles.smallPhoto}
                  />
                </View>
              </View>
          ...
          <View style={styles.session}>
            ...
            <View style={styles.sessionInfo}>
              <View style={{ flex: 1, flexDirection: "row" }}>
                ...
                >
                  <Image
                    source={{ uri: sessions[1][0] }}
                    style={styles.smallPhoto}
                  />
                  <Image
                    source={{ uri: sessions[1][1] }}
                    style={styles.smallPhoto}
                  />
                  <Image
                    source={{ uri: sessions[1][2] }}
                    style={styles.smallPhoto}
                  />
                  <Image
                    source={{ uri: sessions[1][3] }}
                    style={styles.smallPhoto}
                  />
                  <Image
                    source={{ uri: sessions[1][4] }}
                    style={styles.smallPhoto}
                  />
                </View>
              </View>
          ...
          <View style={styles.session}>
            ...
            <View style={styles.sessionInfo}>
              <View style={{ flex: 1, flexDirection: "row" }}>
                ...
                >
                  <Image
                    source={{ uri: sessions[3][0] }}
                    style={styles.smallPhoto}
                  />
                  <Image
                    source={{ uri: sessions[3][1] }}
                    style={styles.smallPhoto}
                  />
                </View>
              </View>
        ...
        {/*Because scrollview cuts off bottom*/}
      </ScrollView>
    );
  }
}
